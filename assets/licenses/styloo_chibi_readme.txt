...
Just use an unlit/emission shader, it would work best 
...
Or if you persist to use metroughness workflow : try to see what roughness and metallic works best for you(I recommend to put the roughness value to 1 )

in unity you can change the materials type, standard to unlit/texture

Also if you have problems with some areas like skirts, you can always render both faces, disabling backface culling
